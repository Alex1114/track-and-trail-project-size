...
parser.add_argument('--milestones', default="180,350,480,620", type=str,
...
if __name__ == '__main__':
    ...
    for dataset_path in args.datasets:
        if args.dataset_type == 'track_and_trail':
            dataset = track_and_trail_Dataset(dataset_path, transform=train_transform,
                                 target_transform=target_transform)
            label_file = os.path.join(args.checkpoint_folder, "track_and_trail.txt")
    ...
    if args.dataset_type == "track_and_trail":
        val_dataset = track_and_trail_Dataset(args.validation_dataset, transform=test_transform,
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
            ...
            if args.net == 'mb1-ssd':
                model_path = os.path.join(args.checkpoint_folder, "track_and_trail_v1/Epoch-{}-Loss-{:.4f}.pth".format(epoch, val_loss))
            elif args.net == 'mb1-ssd-lite':
                model_path = os.path.join(args.checkpoint_folder, "track_and_trail_v1_lite/Epoch-{}-Loss-{:.4f}.pth".format(epoch, val_loss))
            elif args.net == 'mb2-ssd-lite':
                model_path = os.path.join(args.checkpoint_folder, "track_and_trail_v2_lite/Epoch-{}-Loss-{:.4f}.pth".format(epoch, val_loss))
